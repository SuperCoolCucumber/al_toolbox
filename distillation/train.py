...
def sanity_checks(args):
    ...
    if args.mlm:
        ...
        assert (args.student_type in ["roberta", "distilbert", "electra"]) and (
            args.teacher_type in ["roberta", "bert", "electra"]
        )
    else:
...
def main():
    ...
    parser.add_argument(
        "--student_type",
        type=str,
        choices=["distilbert", "roberta", "gpt2", "electra"],
        required=True,
    ...
    parser.add_argument(
        "--teacher_type",
        choices=["bert", "roberta", "gpt2", "distilbert", "electra"],
        required=True,
    ...
    parser.add_argument(
        ...
        default=0.0,
        type=float,
        help="Linear weight of the activation loss. Must be >=0.",
    )
